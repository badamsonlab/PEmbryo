        ...
        for file in os.listdir(folder):
            if ID == file:
                ...
                if flag==1:
                    ...
                    nick_position = int(ref_row[1]['nick position'])
        ...
        ### align reads
                ...
                if flag==1:
                    ...
                    for r,read in enumerate(valid_reads):
                        alignment_score_1 = pairwise2.align.globalds(read[1][window[0]:window[1]].upper(),WT_ref[window[0]:window[1]].upper(), match_dic, -3, -1, one_alignment_only=True,score_only=True)
                        alignment_score_2 = pairwise2.align.globalds(read[1][nick_position-17:nick_position+17].upper(),WT_ref[nick_position-17:nick_position+17].upper(), match_dic, -3, -1, one_alignment_only=True,score_only=True)
                        if alignment_score_1==int(window[1]-window[0]) and alignment_score_2==34:
                            wt+=1
                            wt_reads.append(read)
                        else:
                            alignment_score_1 = pairwise2.align.globalds(read[1][window[0]:window[1]].upper(),PE_ref[window[0]:window[1]].upper(), match_dic, -3, -1, one_alignment_only=True,score_only=True)
                            alignment_score_2 = pairwise2.align.globalds(read[1][nick_position-17:nick_position+17].upper(),WT_ref[nick_position-17:nick_position+17].upper(), match_dic, -3, -1, one_alignment_only=True,score_only=True)
